export default {
    Header: {
        ...
        link1: 'Meine Arbeitsbereiche',
        link2: 'Über mich',
        link3: 'Wie arbeite ich',
        link4: '',
        link5: 'Meine Qualifikation',
        link6: 'Kontakte',
        link7: '',
    },
    AboutMe: {
    ...
    HowIWork: {
        ...
        text1: 'Ich respektiere Ihre Individualität, Ihre Vorlieben und Werte, ich stelle sie nicht infrage und dränge Ihnen nicht meine eigenen auf.',
    ...
    Qualification: {
        ...
        myQualification: 'Meine Qualifikationen',
    },
    Reviews: {
        myReviews: '',
        text: '',
    ...
    WithWhatIWork: {
        ...
        Difficulties: {
            ...
            text1: 'Unzufriedenheit mit sich selbst, mit den eigenen Handlungen und Entscheidungen',
            text2: 'Erleben von komplexen Gefühlen wie Scham, Schuld, Groll, Wut',
            text3: 'emotionale Probleme - Ängste, Unruhe, Apathie, Stimmungsschwankungen, Depression, Psychosomatik;',
            text4: 'Erfahrungen im Zusammenhang mit traumatischen Ereignissen in der Vergangenheit',
            text5: 'Anpassung im fremden Land nach der Auswanderung',
            text6: 'Erfahrung und Angst vor Einsamkeit',
            text7: 'Umgang mit Trauer, Verlust geliebter Menschen',
            text8: '',
            text9: '',
        },
        PersonalDevelopment: {
            personalDevelopment: 'Persönliche Entwicklung und Selbstwertgefühl',
            text1: 'Angst, sich auszudrücken',
            text2: 'Schwierigkeiten, die eigenen Talente und Fähigkeiten zu verstehen',
            text3: 'Unzufriedenheit mit dem Beruf',
            text4: '',
            text5: '',
            text6: '',
            text7: '',
        ...
        DifficultiesWithOthers: {
            ...
            text1: 'Mit dem Partner: gegenseitige Ansprüche, Unzufriedenheit, Untreue, Scheidung, Eifersucht, Verlust des Partners, emotionale Abhängigkeit;',
            text2: 'Zwischen Eltern und Kindern: fehlendes gegenseitiges Verständnis, Trennungsprobleme, Schwierigkeiten in der Pubertät, „Empty-Nest“-Syndrom.»',
            text3: 'Mit Freunden, Mitarbeitern, Kollegen, Vorgesetzten: Mangel an Selbstvertrauen, Unfähigkeit, die eigene Position zu verteidigen, Angst vor Verurteilung oder Missbilligung gegenüber sich selbst, Unfähigkeit Nein zu sagen;»',
            text4: '',
        },
    },
}
